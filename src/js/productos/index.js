...
const getProductos = async (alerta = 'si') => {
    ...
    const url = `/libreria_js/controladores/productos/index.php?producto_nombre=${nombre}&producto_precio=${precio}`
    const config = {
        method: 'GET'
    }
...
const guardarProductos = async (e) => {
    ...
    const url = '/libreria_js/controladores/productos/index.php'
